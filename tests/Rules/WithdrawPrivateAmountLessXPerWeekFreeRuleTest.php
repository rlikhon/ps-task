...
class WithdrawPrivateAmountLessXPerWeekFreeRuleTest extends RuleTest
{
    ...
    {
        return [
            'private withdraw 10 EUR' => [[[1000, '2021-04-26', 'EUR', 1, RuleTest::USER_TYPE_PRIVATE, RuleTest::OPERATION_TYPE_WITHDRAW]], true],
            ...
            'private withdraw 0 EUR' => [[[0, '2021-04-26', 'EUR', 1, RuleTest::USER_TYPE_PRIVATE, RuleTest::OPERATION_TYPE_WITHDRAW]], true],
            'private withdraw 1000 EUR' => [[[100000, '2021-04-26', 'EUR', 1, RuleTest::USER_TYPE_PRIVATE, RuleTest::OPERATION_TYPE_WITHDRAW]], true],
            ...
            'private withdraw 1000 EUR in JPY' => [[[129530, '2021-04-26', 'JPY', 1, RuleTest::USER_TYPE_PRIVATE, RuleTest::OPERATION_TYPE_WITHDRAW]], true],
    ...
    {
        return [
            'private withdraw 1000 EUR' => [[[100000, '2021-04-26', 'EUR', 1, RuleTest::USER_TYPE_PRIVATE, RuleTest::OPERATION_TYPE_WITHDRAW]], 0, 'EUR', true],
            'private withdraw 500+100 EUR' => [
                [
                    [50000, '2021-04-26', 'EUR', 1, RuleTest::USER_TYPE_PRIVATE, RuleTest::OPERATION_TYPE_WITHDRAW],
                    [10000, '2021-04-26', 'EUR', 1, RuleTest::USER_TYPE_PRIVATE, RuleTest::OPERATION_TYPE_WITHDRAW],
                ],
                0,
                'EUR',
                true,
            ...
            'private withdraw 500 EUR in JPY' => [[[64765, '2021-04-26', 'JPY', 1, RuleTest::USER_TYPE_PRIVATE, RuleTest::OPERATION_TYPE_WITHDRAW]], 0, 'JPY',true],
        ];
    }
}
